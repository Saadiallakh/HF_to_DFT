...
st.set_page_config(page_title="Multilayer Perceptron", page_icon=":bar_chart:")
...
def show_input_page():
    """
    Displays the input page for the Multilayer Perceptron model.
    Allows users to input required values and upload an XYZ file.
    """
    #-# Display the title and description
    st.markdown("<h1 style='text-align: center;'>Multilayer Perceptron</h1>", unsafe_allow_html=True)
