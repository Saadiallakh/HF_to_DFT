...
st.set_page_config(page_title="Elastic Net Regression", page_icon=":bar_chart:")
...
def show_input_page():
    """
    Displays the input page for the Elastic Net Regression model.
    Allows users to input required values and upload an XYZ file.
    """
    #-# Display the title and description
    st.markdown("<h1 style='text-align: center;'>Elastic Net Regression</h1>", unsafe_allow_html=True)
