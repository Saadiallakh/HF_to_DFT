...
best_rf.fit(X_train_numeric_scaled, y_train_scaled)

#-# Save the trained model
model_dir = "./output"

joblib.dump(best_rf, os.path.join(model_dir, 'random_forest_model.pkl'))
print(f"Trained model with Optuna saved to {os.path.join(model_dir, 'random_forest_model.pkl')}")
 
#-# Predict values on the test data
y_pred_scaled = best_rf.predict(X_test_numeric_scaled)
